 ...
 */
class H2Push {
  implicit val con: java.sql.Connection = DriverManager.getConnection("jdbc:h2:/home/justin/Development/scala/lecarton/.data")

  def createPaste(owner: Long, pasteId: String, title: String, message: String, isPrivate: Boolean): Unit = {
  ...
  def createUserProfile(username: String, password: String, email: String): Option[Long] = {
